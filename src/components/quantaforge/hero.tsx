        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-base md:text-lg text-quantaforge-light/70 max-w-4xl mx-auto">
              From compiler stacks for real quantum hardware to quantum-secure tokenization and simulation for drug
              discovery,ship production-grade quantum software with the power of quantum computing.
            </p>
          </motion.div>
        </div>
      </div>
