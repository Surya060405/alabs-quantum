...
const Tokenization = () => {
  ...
  const outcomes = ["Crypto-agile posture; staged rollout without breaking legacy flows.", "Reduced breach surface via tokenization and policy controls."];
        ...
        <section className="py-24 bg-quantaforge-primary/50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {capabilities.map((item, index) => <motion.div key={item.title} initial={{
              opacity: 0,
              y: 20
            }} whileInView={{
              opacity: 1,
          ...
          <div className="container mx-auto px-4">
            ...
            once: true
              ...
              <div className="grid md:grid-cols-2 gap-8">
                {referenceArchitectures.map((arch, index) => <motion.div key={index} className="p-6 rounded-xl border border-quantaforge-accent/20 bg-quantaforge-primary/50 flex flex-col items-center text-center" initial={{
                opacity: 0,
                y: 20
              }} whileInView={{
                opacity: 1,
        ...
        <section className="py-24 bg-quantaforge-primary/50">
          <div className="container mx-auto px-4">
            ...
            <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
              {outcomes.map((outcome, index) => <motion.div key={index} initial={{
              opacity: 0,
              x: -20
            }} whileInView={{
              opacity: 1,
