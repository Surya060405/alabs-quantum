...
const AiMlNlp = () => {
  ...
  const technologies = [
    "PyTorch", "TensorFlow", "Keras", "Scikit-learn", "H2O.ai", "ONNX",
    "RASA", "BERT", "GPT-3", "OCR", "BioPython", "Computer Vision",
    "NLP", "Deep Learning", "Neural Networks", "Generative AI"
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-6xl font-bold mb-6">
              <span className="text-gradient-blue">AI, GenAI & Computer Vision</span>
            </h1>
            <p className="text-xl text-muted-foreground leading-relaxed">
              Advanced machine learning, natural language processing, and generative AI solutions for next-generation applications
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed mb-6">
              Our AI and Machine Learning team delivers cutting-edge solutions that transform raw data into actionable insights. 
              From conversational AI to computer vision, we leverage state-of-the-art models and frameworks to solve complex problems.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
              We specialize in custom AI solutions for diverse domains including healthcare (biomedical imaging, genomics), 
              fintech (risk management), and conversational interfaces. Our expertise spans traditional ML, deep learning, 
              NLP, and the latest generative AI technologies.
            </p>
          </motion.div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-4xl font-bold mb-4">
              <span className="text-gradient-blue">Technologies & Frameworks</span>
            </h2>
            <p className="text-xl text-muted-foreground">
              Industry-leading AI/ML tools and frameworks
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground mb-8">
              Let's explore how artificial intelligence can revolutionize your operations
            </p>
            <Link
              to="/#contact"
